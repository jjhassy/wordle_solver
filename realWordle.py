...
def startChromeStuff():
  ...
  chrome_options.add_argument('--log-level=3')  # Set log level to suppress most logs
  chrome_options.add_argument('--ignore-certificate-errors')  # Ignore certificate errors
  
  cService = webdriver.ChromeService(executable_path='./chromedriver-win64/chromedriver.exe') # change chromedriver directory if it's mac/linux, etc.
